...
class CodeIntelTypeScriptClientConfig(ClientConfig):
    def __init__(self):
        ...
        self.binary_args = [
            ...
            "--logfile", "~/.codeintel/typescript.log",
            "--logVerbosity", "terse",
            "--traceToConsole", "true",
        ]
        self.tcp_port = None
...
class CodeIntelTypeScriptPlugin(LanguageHandler):
    def __init__(self):
        self._server_name = "TypeScript Language Server"
        self._config = CodeIntelTypeScriptClientConfig()
